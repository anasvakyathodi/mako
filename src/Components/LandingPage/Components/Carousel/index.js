...
import "./Carousel.css";
import { Container, Row, Col, Media, Carousel, Image } from "react-bootstrap";
...
const featurelist = [
  { id: 1, icon: childIcon, count: "850+", text: "REGISTERED ENROLLS" },
  { id: 2, icon: likeIcon, count: "1300+", text: "FINISHED SESSIONS" },
  { id: 3, icon: copyIcon, count: "83%", text: "SATISFACTION RATE" },
];
